...
/**
 * H3K | PKL2020 File Manager V2.4.3
...
//Application Title
define('APP_TITLE', 'PKL2020 File Manager');
...
// Generate secure password hash - https://polinela.ac.id/docs/pwd.html
$auth_users = array(
   'admin' => '$2y$10$c3NvV.V5STX21EIceBa8D.GYNe8z0r8nCh0VdpXaczPhFGk9XSrTO', //admin@123
    'user' => '$2y$10$0F4KN2pxt6oE8FTFGBavAOn6t.iHAFBKzIe2hbjFqJK/aVjRp.iQq' //12
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://polinela.ac.id/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">PKL 2020</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://polinela.ac.id/hmm" target="_blank" class="app-v-title"> PKL2020 File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: PutriMellyana</p>
                        <p>Mail Us: <a href="mailto:putrimell@gmail.com">putrimellyana[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item"><a href="https://polinela.ac.id/hmm/wiki" target="_blank"><i class="fa fa-question-circle"></i> <?php echo lng('Help Documents') ?> </a> </li>
                                <li class="list-group-item"><a href="https://polinela.ac.id/hmm/issues" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://polinela.ac.id" target="_blank" class="float-right text-muted">PKL2020 File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://polinela.ac.id" target="_blank" class="float-right text-muted">PKL2020 File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'PKL2020 File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with PKL2020 File Manager">
...
<script>
    ...
    //TFM Config
    window.curi = "https://polinela.ac.id/config.json", window.config = null;
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'PKL2020 File Manager';      $tr['en']['AppTitle']           = 'File Manager';
